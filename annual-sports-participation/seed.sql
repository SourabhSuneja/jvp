...
-- Back Running
INSERT INTO sport_events (game_name, class_category, game_type, group_size, gender_filter) VALUES
('Back Running (Boys)', '7', 'Individual', 1, 'Boys'),
('Back Running (Boys)', '8', 'Individual', 1, 'Boys'),
('Back Running (Boys)', '9', 'Individual', 1, 'Boys'),
('Back Running (Boys)', '10', 'Individual', 1, 'Boys'),
('Back Running (Boys)', '11', 'Individual', 1, 'Boys'),
('Back Running (Boys)', '12', 'Individual', 1, 'Boys'),
('Back Running (Girls)', '7', 'Individual', 1, 'Girls'),
('Back Running (Girls)', '8', 'Individual', 1, 'Girls'),
('Back Running (Girls)', '9', 'Individual', 1, 'Girls'),
('Back Running (Girls)', '10', 'Individual', 1, 'Girls'),
('Back Running (Girls)', '11', 'Individual', 1, 'Girls'),
('Back Running (Girls)', '12', 'Individual', 1, 'Girls');

-- Hurdle Race
INSERT INTO sport_events (game_name, class_category, game_type, group_size, gender_filter) VALUES
('Hurdle Race (Boys)', '7', 'Individual', 1, 'Boys'),
('Hurdle Race (Boys)', '8', 'Individual', 1, 'Boys'),
('Hurdle Race (Boys)', '9', 'Individual', 1, 'Boys'),
('Hurdle Race (Boys)', '10', 'Individual', 1, 'Boys'),
('Hurdle Race (Boys)', '11', 'Individual', 1, 'Boys'),
('Hurdle Race (Boys)', '12', 'Individual', 1, 'Boys'),
('Hurdle Race (Girls)', '7', 'Individual', 1, 'Girls'),
('Hurdle Race (Girls)', '8', 'Individual', 1, 'Girls'),
('Hurdle Race (Girls)', '9', 'Individual', 1, 'Girls'),
('Hurdle Race (Girls)', '10', 'Individual', 1, 'Girls'),
('Hurdle Race (Girls)', '11', 'Individual', 1, 'Girls'),
('Hurdle Race (Girls)', '12', 'Individual', 1, 'Girls');
