...
let classes = ['1-A1', '1-A2', '1-A3', '2-A1', '2-A2', '2-A3', '2-A4', '3-A1', '3-A2', '3-A3', '3-A4', '4-A1', '4-A2', '4-A3', '4-A4', '5-A1', '5-A2', '5-A3', '5-A4', '6-A1', '6-A2', '6-A3', '6-A4', '7-A1', '7-A2', '7-A3', '7-A4', '8-A1', '8-A2', '8-A3', '8-A4', '9-A1', '9-A2', '9-A3', '9-A4', '10-A1', '10-A2', '10-A3', '11-SCI', '11-COM', '11-HUM', '12-SCI', '12-COM', '12-HUM'];
...
const aggregateMarks = {
  ...
  9: {'PT-1': 120, 'PT-2': 120, 'PT-3': 120, 'PT-4': 120, 'Term-1': 480, 'Term-2': 480},
  10: {'PT-1': 120, 'PT-2': 120, 'PT-3': 120, 'PT-4': 120, 'Term-1': 480, 'Term-2': 480},
  11: {'PT-1': 100, 'PT-2': 100, 'PT-3': 100, 'PT-4': 100, 'Term-1': 400, 'Term-2': 400},
  12: {'PT-1': 100, 'PT-2': 100, 'PT-3': 100, 'PT-4': 100, 'Term-1': 360, 'Term-2': 360},
  10: {'MT-1': 120, 'MT-2': 120, 'MT-3': 120, 'MT-4': 120, 'MT-5': 120, 'MT-6': 120},
  12: {'MT-1': 100, 'MT-2': 100, 'MT-3': 100, 'MT-4': 100, 'MT-5': 100, 'MT-6': 100}
};
...
const exams = [
             ...
             {'name': 'Enthusiasm (April/May)', 'mm': 300},
             {'name': 'Enthusiasm (July)', 'mm': 320},
...
function getMaxMarks(examName, className=null, subjectName=null) {
   ...
   if(examName && (examName.includes('Term-') || examName.includes('Term-')) && exams.find(e => e.name === examName)) {
...
const examMarksConfig = [
    ...
    {
      "classes": [11],
      "subjects": ["Maths", "Accountancy", "B.St.", "Economics", "History", "Pol. Sci.", "Applied Maths"],
      "exams": {
        "Term-1 (Theory)": 80,
        "Term-2 (Theory)": 80,
        "Term-2 (Practical)": 20
